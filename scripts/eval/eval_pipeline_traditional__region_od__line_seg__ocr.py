...
from vlm.evaluation.utils import evaluate_multiple_pages, evaluate_one_page
...
pipeline = TraditionalPipeline(
    pipeline_type           = "region_od__line_seg__ocr",
    region_od_model_path    = PROJECT_DIR / f"models/trained/yolo11m__{SPLIT_TYPE}__page__region_od/weights/best.pt",
    line_seg_model_path     = PROJECT_DIR / f"models/trained/yolo11m_seg__{SPLIT_TYPE}__region__line_seg/weights/best.pt",
