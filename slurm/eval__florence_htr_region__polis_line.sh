...
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -J eval__florence_htr_region__polis_line
#SBATCH -o logs_uppmax/eval__florence_htr_region__polis_line.out
#SBATCH -e logs_uppmax/eval__florence_htr_region__polis_line.err
#SBATCH --gres=gpu:1
