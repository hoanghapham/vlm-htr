...
#SBATCH -N 1
#SBATCH -t 12:00:00
#SBATCH -J eval/yolo11m/sbs__page__region_od__vanilla
#SBATCH -o logs_uppmax/eval/yolo11m/sbs__page__region_od__vanilla.out
#SBATCH -e logs_uppmax/eval/yolo11m/sbs__page__region_od__vanilla.out
#SBATCH --gres=gpu:1
...
python pipelines/eval/eval_yolo_od.py \
    ...
    --model-name yolo11m__sbs__page__region_od__vanilla \
    --checkpoint vanilla \
    --batch-size 10 \
