...
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -J eval/florence_base/ft_htr_line/hovratt_region
#SBATCH -o logs_uppmax/eval/florence_base/ft_htr_line/hovratt_region.out
#SBATCH -e logs_uppmax/eval/florence_base/ft_htr_line/hovratt_region.err
#SBATCH --gres=gpu:1
