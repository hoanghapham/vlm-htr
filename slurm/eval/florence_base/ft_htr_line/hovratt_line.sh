...
#SBATCH -N 1
#SBATCH -t 12:00:00
#SBATCH -J eval/florence_base/ft_htr_line/hovratt_line
#SBATCH -o logs_uppmax/eval/florence_base/ft_htr_line/hovratt_line.out
#SBATCH -e logs_uppmax/eval/florence_base/ft_htr_line/hovratt_line.err
#SBATCH --gres=gpu:1
