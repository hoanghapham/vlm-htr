...
#SBATCH -N 1
#SBATCH -t 1-00:00
#SBATCH -J eval/florence_base/mixed__region__line_od
#SBATCH -o logs_uppmax/eval/florence_base/mixed__region__line_od.out
#SBATCH -e logs_uppmax/eval/florence_base/mixed__region__line_od.out
#SBATCH --gres=gpu:1
