...
#SBATCH -N 1
#SBATCH -t 1-00:00
#SBATCH -J eval/florence_base/sbs__page__line_od
#SBATCH -o logs_uppmax/eval/florence_base/sbs__page__line_od.out
#SBATCH -e logs_uppmax/eval/florence_base/sbs__page__line_od.out
#SBATCH --gres=gpu:1
