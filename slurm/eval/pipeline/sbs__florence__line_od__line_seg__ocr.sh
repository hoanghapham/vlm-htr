...
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -J eval/pipeline/sbs__florence__line_od__line_seg__ocr
#SBATCH -o logs_uppmax/eval/pipeline/sbs__florence__line_od__line_seg__ocr.out
#SBATCH -e logs_uppmax/eval/pipeline/sbs__florence__line_od__line_seg__ocr.out
#SBATCH --gres=gpu:1
