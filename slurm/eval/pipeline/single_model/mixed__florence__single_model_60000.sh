...
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -J eval/pipeline/mixed__florence__single_model_60000
#SBATCH -o logs_uppmax/eval/pipeline/mixed__florence__single_model_60000.out
#SBATCH -e logs_uppmax/eval/pipeline/mixed__florence__single_model_60000.out
#SBATCH --gres=gpu:1
