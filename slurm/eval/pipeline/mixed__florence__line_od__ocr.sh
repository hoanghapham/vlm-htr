...
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -J eval/pipeline/mixed__florence__line_od__ocr
#SBATCH -o logs_uppmax/eval/pipeline/mixed__florence__line_od__ocr.out
#SBATCH -e logs_uppmax/eval/pipeline/mixed__florence__line_od__ocr.out
#SBATCH --gres=gpu:1
