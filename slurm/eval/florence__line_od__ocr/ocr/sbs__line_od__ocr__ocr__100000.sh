...
#SBATCH -N 1
#SBATCH -t 3-00:00
#SBATCH -J eval/florence_base/sbs__line_od__ocr__ocr_100000
#SBATCH -o logs_uppmax/eval/florence_base/sbs__line_od__ocr__ocr_100000.out
#SBATCH -e logs_uppmax/eval/florence_base/sbs__line_od__ocr__ocr_100000.out
#SBATCH --gres=gpu:1
