...
#SBATCH -t 24:00:00
#SBATCH -C mem512GB
#SBATCH -J data_process/create_trolldoms__line_seg
#SBATCH -o logs_uppmax/data_process/create_trolldoms__line_seg.out
#SBATCH -e logs_uppmax/data_process/create_trolldoms__line_seg.out
