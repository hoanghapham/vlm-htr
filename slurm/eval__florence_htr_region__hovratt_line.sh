...
#SBATCH -N 1
#SBATCH -t 12:00:00
#SBATCH -J eval__florence_htr_region__hovratt_line
#SBATCH -o logs_uppmax/eval__florence_htr_region__hovratt_line.out
#SBATCH -e logs_uppmax/eval__florence_htr_region__hovratt_line.err
#SBATCH --gres=gpu:1
