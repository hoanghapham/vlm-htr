...
#SBATCH -N 1
#SBATCH -t 3-00:00
#SBATCH -J finetune/florence_base/sbs__line_bbox__ocr
#SBATCH -o logs_uppmax/finetune/florence_base/sbs__line_bbox__ocr.out
#SBATCH -e logs_uppmax/finetune/florence_base/sbs__line_bbox__ocr.out
#SBATCH --gres=gpu:1
