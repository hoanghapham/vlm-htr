...
#SBATCH -N 1
#SBATCH -t 3-00:00
#SBATCH -J finetune/florence_base/mixed__region_od__line_od__line_seg
#SBATCH -o logs_uppmax/finetune/florence_base/mixed__region_od__line_od__line_seg.out
#SBATCH -e logs_uppmax/finetune/florence_base/mixed__region_od__line_od__line_seg.out
#SBATCH --gres=gpu:1
